...
// const token = "NzIzOTc5NTkyMDI0NzE5Mzcw.XwfMbA.NDwH2tuUy-NmtxV59qB4b_0FFms"
...
// try{
// //we removed both main and alt prefix, so all those need to be changed and moved
//     if (cont.substring(0, prefix.length).toLowerCase() == prefix) {
